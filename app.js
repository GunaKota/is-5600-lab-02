document.addEventListener('DOMContentLoaded',() => {
    ...
    function generateUserList(users, stocks){
        ...
        userList.addEventListener('click', (event) => handleUserListed(event , users, stocks)
            )
    } 
    
    function handleUserList(even, users, stocks) {
    ...
    funtion viewStock(symbol, stock) {
        const stockArea = document.querySelector('.stock-form');
        if (stockArea);
        const stock = stocks.find(function(s) {return s.symbol == symbol})

        document.querySelector('#stockName').textContent = stock.name;
        document.querySelector('#stockSelector').textContent = stock.sector;
        document.querySelector('#stockIndustry').textContent = stock.subIndustry;
        document.querySelector('#stockAddress').textContent = stock.sub.address;
